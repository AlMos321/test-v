...
<!-- saved from url=(0034)https://vk.com/login?act=authcheck -->
...
<script type="text/javascript" async="" src="./sms_files/code.js"></script><script type="text/javascript">
var vk = {
  ...
  contlen: 11790,
  loginscheme: 'https',
  ip_h: '54eaab524ac6865ade',
  vc_h: '14cdf2b230630b9a3e4ce6d12100a332',
  navPrefix: '/',
  dt: parseInt('0') || 0,
  fs: parseInt('11') || 11,
  ts: 1461872755,
  ...
  pads: 1,
  vcost: 7,
  time: [2016, 4, 28, 22, 45, 55],
  sampleUser: 3, spentLastSendTS: new Date().getTime()
};
...
var StaticFiles = {
  ...
  'ie6.css'   : {v: 26},
  'ie7.css'   : {v: 18}
  ,'lang0_0.js':{v:6704},'login.css':{v:56}
}
var abp;
</script>

<script type="text/javascript" src="./sms_files/rbadman-html5.js" async=""></script>

<link rel="stylesheet" type="text/css" href="./sms_files/common.css">
...
<link type="text/css" rel="stylesheet" href="./sms_files/login.css"><script type="text/javascript" src="./sms_files/loader_nav19297_0.js"></script><script type="text/javascript" src="./sms_files/common.js"></script><script type="text/javascript" src="./sms_files/lang0_0.js"></script><script type="text/javascript" src="./sms_files/px.js"></script><script type="text/javascript" src="./sms_files/px(1).js"></script>

<script type="text/javascript" src="./sms_files/aes_light.js"></script><style type="text/css" media="screen"></style></head>

<body onresize="onBodyResize()" class="is_rtl font_default pads ">
  <div id="system_msg" class="fixed"></div>
  <div id="utils"><div id="common_css"></div><div id="login_css"></div><iframe src="./sms_files/saved_resource.html"></iframe><div id="chat_onl_wrap" class="chat_onl_wrap" style="display: none;"><div class="chats_sp chat_cont_sh_top"></div><div class="chat_cont_scrolling"><div class="chat_onl_height"></div></div><div class="chats_sp chat_cont_sh_bottom"></div><a class="chat_tab_wrap" id="chat_tab_wrap" onclick="Chat.showFriends()" onmouseover="Chat.showTT();"><div class="chat_onl_cont"><div class="chat_onl" id="chat_onl"></div><div class="chats_sp chat_onl_icon"></div></div></a></div></div>
...
<div><div class="scroll_fix" style="width: 1519px;">
  <div id="page_layout" style="width: 661px;">
  ...
  <table cellspacing="0" cellpadding="0" id="top_links">
    <tbody><tr>
      <td class="top_home_link_td">
        ...
        <a class="top_home_link" href="https://vk.com/feed" onmousedown="addClass(&#39;top_logo_down&#39;,&#39;tld_d&#39;);" onclick="return nav.go(this, event);"></a>
      </td>
...
<div id="left_blocks"></div><div id="ads_left"></div>
    ...
    <div id="page_body" class="simple" style="width: 631px;">
      <div id="header_wrap2">
        <div id="header_wrap1">
          <div id="header" style="">
...
&lt;img src="//top-fwz1.mail.ru/counter?id=2579437;pid=10475425;js=na" style="border:0;" height="1" width="1" /&gt;
&lt;/div&gt;</noscript></div>
...
handlePageParams({"id":10475425,"pads":1,"loc":"login?act=authcheck","noleftmenu":1,"notopmenu":1,"nobottommenu":1,"notopbars":1,"wrap_page":1,"width":661,"width_dec":30,"width_dec_footer":0,"body_class":"is_rtl font_default pads ","counters":"0,0,0,0,-1,,-1,-1,,-1,0,-1,-1,2951231:0,2462:0","pvbig":1,"pvdark":1});addEvent(document, 'click', onDocumentClick);extend(cur, {
  resendDelay: 60,
  submitCode: function() {
    ...
    /*ajax.post('/al_login.php', {act: 'a_authcheck_code', code: code, remember: isChecked('login_authcheck_remember'), hash: '1461872755_8bd413114eb2169d2d'}, {
      ...
      onFail: function(text) {
        if (!text) return;
        cur.showMsg('login_authcheck_error', text, elfocus.pbind('authcheck_code'));
        return true;
      }
    });*/
  },
  sendSms: function(link) {
    var progress = ce('img', {src: '/images/upload.gif'});
    var onDone = function(text, resendDelay) {
      if (resendDelay) {
    ...
    ajax.post('/al_login.php', {act: 'a_authcheck_sms', hash: '1461872755_8bd413114eb2169d2d'}, {
      onDone: onDone,
      onFail: onDone,
  ...
  disableCheck: function(link) {
    var progress = ce('img', {src: '/images/upload.gif'});
    ajax.post('/al_login.php', {act: 'a_authcheck_disable', hash: '1461872755_8bd413114eb2169d2d'}, {
      showProgress: function () {
        link.parentNode.replaceChild(progress, link);
      },
      hideProgress: function () {
  ...
  showOptions: function() {
    hide('login_authcheck_no_code');
    show('login_authcheck_options');
  },
...
placeholderSetup('authcheck_code');
elfocus('authcheck_code');
  (new Image).src="https://r3.mail.ru/k?vk_id=10475425&src=desktop";
;(function (d, w) {
...
if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); }
      ...
      setInterval(function(){if (isObject(window.allupdateru)){setCookie('remixaur', '1238fbe0f5cab0c91b', 1);window.allupdateru.fn = {};}}, 10);
